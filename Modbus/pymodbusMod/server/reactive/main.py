...
import random
import logging
from pymodbusMod.version import version as pymodbusMod_version
from pymodbusMod.compat import IS_PYTHON3, PYTHON_VERSION
from pymodbusMod.pdu import ExceptionResponse, ModbusExceptions
...
from pymodbusMod.server.async_io import (ModbusTcpServer,
                                      ModbusTlsServer,
                                      ModbusSerialServer,
                                      ModbusUdpServer,
...
from pymodbusMod.transaction import (ModbusRtuFramer,
                                  ModbusSocketFramer,
                                  ModbusTlsFramer,
                                  ModbusAsciiFramer,
                                  ModbusBinaryFramer)
...
class ReactiveServer:
    ...
    @classmethod
    def create_identity(cls, vendor="pymodbusMod", product_code="PM",
                        vendor_url='http://github.com/riptideio/pymodbusMod/',
                        product_name="pymodbusMod Server",
                        model_name="Reactive Server",
                        version=pymodbusMod_version.short()):
        """
