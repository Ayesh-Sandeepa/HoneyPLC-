...
'''
import struct
from pymodbusMod.constants import ModbusStatus
from pymodbusMod.pdu import ModbusRequest
from pymodbusMod.pdu import ModbusResponse
from pymodbusMod.device import ModbusControlBlock, DeviceInformationFactory
from pymodbusMod.compat import byte2int, int2byte
...
class ReportSlaveIdRequest(ModbusRequest):
    ...
    def execute(self, context=None):
        ...
        if not reportSlaveIdData:
            ...
            identifier = identifier or b'pymodbusMod'
