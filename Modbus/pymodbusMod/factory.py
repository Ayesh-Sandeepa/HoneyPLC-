...
from pymodbusMod.pdu import IllegalFunctionRequest
from pymodbusMod.pdu import ExceptionResponse
from pymodbusMod.pdu import ModbusRequest, ModbusResponse
from pymodbusMod.pdu import ModbusExceptions as ecode
from pymodbusMod.interfaces import IModbusDecoder
from pymodbusMod.exceptions import ModbusException, MessageRegisterException
from pymodbusMod.bit_read_message import *
from pymodbusMod.bit_write_message import *
from pymodbusMod.diag_message import *
from pymodbusMod.file_message import *
from pymodbusMod.other_message import *
from pymodbusMod.mei_message import *
from pymodbusMod.register_read_message import *
from pymodbusMod.register_write_message import *
from pymodbusMod.compat import byte2int
...
class ClientDecoder(IModbusDecoder):
    ...
    def register(self, function=None, sub_function=None, force=False):
        ...
        if function and not issubclass(function, ModbusResponse):
            raise MessageRegisterException("'{}' is Not a valid Modbus Message"
                                           ". Class needs to be derived from "
                                           "`pymodbusMod.pdu.ModbusResponse` "
                                           "".format(
                function.__class__.__name__
            ))
        self.__lookup[function.function_code] = function
