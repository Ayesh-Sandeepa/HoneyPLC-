"""
Command Completion for pymodbusMod REPL.
...
from pymodbusMod.repl.client.helper import get_commands
from pymodbusMod.compat import string_types
...
class CmdCompleter(Completer):
    """
    Completer for pymodbusMod REPL.
    """
