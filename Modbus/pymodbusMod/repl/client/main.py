...
from pymodbusMod.repl.client.completer import CmdCompleter, has_selected_completion
from pymodbusMod.repl.client.helper import Result, CLIENT_ATTRIBUTES
...
def main(ctx, verbose, broadcast_support, retry_on_empty,
    ...
    if verbose:
        ...
        log = logging.getLogger('pymodbusMod')
...
def tcp(ctx, host, port, framer):
    from pymodbusMod.repl.client.mclient import ModbusTcpClient
...
def serial(ctx, method, port, baudrate, bytesize, parity, stopbits, xonxoff,
    ...
    from pymodbusMod.repl.client.mclient import ModbusSerialClient
