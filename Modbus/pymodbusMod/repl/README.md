...
Or
Install pymodbusMod with repl support
```
$ pip install pymodbusMod[repl] --upgrade
```
...
```
✗ pymodbusMod.console --help
Usage: pymodbusMod.console [OPTIONS] COMMAND [ARGS]...
...
```
✗ pymodbusMod.console tcp --help
Usage: pymodbusMod.console tcp [OPTIONS]
...
SERIAL Options
```
✗ pymodbusMod.console serial --help
Usage: pymodbusMod.console serial [OPTIONS]
...
TCP
```
$ pymodbusMod.console tcp --host 192.168.128.126 --port 5020
...
SERIAL
```
$ pymodbusMod.console serial --port /dev/ttyUSB0 --baudrate 19200 --timeout 2
> help
Available commands:
...
```
✗ pymodbusMod.console --broadcast-support tcp --host 192.168.1.8 --port 5020
...
\______   \___.__. /     \   ____   __| _/  \______   \ ____ ______ |  |
 ...
 |____|    / ____\____|__  /\____/\____ | /\ |____|_  /\___  >   __/|____/
           \/            \/            \/ \/        \/     \/|__|
                                        v1.2.0 - [pymodbusMod, version 2.4.0]
----------------------------------------------------------------------------
