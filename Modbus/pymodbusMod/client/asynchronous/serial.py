...
import logging
from pymodbusMod.client.asynchronous.factory.serial import get_factory
from pymodbusMod.transaction import ModbusRtuFramer, ModbusAsciiFramer, ModbusBinaryFramer, ModbusSocketFramer
from pymodbusMod.factory import ClientDecoder
from pymodbusMod.exceptions import ParameterException
from pymodbusMod.compat import IS_PYTHON3, PYTHON_VERSION
from pymodbusMod.client.asynchronous.schedulers import ASYNC_IO
...
class AsyncModbusSerialClient(object):
    ...
    To use do::
        ...
        from pymodbusMod.client.asynchronous.serial import AsyncModbusSerialClient
    """
    @classmethod
