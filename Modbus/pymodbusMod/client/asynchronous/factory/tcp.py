...
from pymodbusMod.client.asynchronous.thread import EventLoopThread
...
def reactor_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from pymodbusMod.client.asynchronous.twisted import ModbusTcpClientProtocol
...
def io_loop_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from pymodbusMod.client.asynchronous.tornado import AsyncModbusTCPClient as \
        Client
...
def async_io_factory(host="127.0.0.1", port=Defaults.Port, **kwargs):
    ...
    """
    import asyncio
    from pymodbusMod.client.asynchronous.async_io import init_tcp_client
