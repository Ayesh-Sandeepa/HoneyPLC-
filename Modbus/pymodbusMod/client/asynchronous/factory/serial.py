...
def io_loop_factory(port=None, framer=None, **kwargs):
    ...
    from pymodbusMod.client.asynchronous.tornado import (AsyncModbusSerialClient as
                                               Client)
...
def async_io_factory(port=None, framer=None, **kwargs):
    ...
    """
    import asyncio
    from pymodbusMod.client.asynchronous.async_io import (ModbusClientProtocol,
